...
exports.b2PolyShape = b2PolyShape = b2PolyShape = (function() {
  ...
  function b2PolyShape(def, body, newOrigin) {
    var aabb, box, broadPhase, centroidX, centroidY, hX, hY, hcX, hcY, i, i1, i2, length, localR, maxVertexX, maxVertexY, minVertexX, minVertexY, poly, positionX, positionY, tVec, uX, uY, v, _ref, _ref2, _ref3, _ref4, _ref5, _ref6;
    ...
    for (i = 0, _ref3 = this.m_vertexCount; 0 <= _ref3 ? i < _ref3 : i > _ref3; 0 <= _ref3 ? i++ : i--) {
      ...
      i1 = i;
      i2 = (_ref4 = i + 1 < this.m_vertexCount) != null ? _ref4 : i + {
        1: 0
      };
    ...
    for (i = 0, _ref5 = this.m_vertexCount; 0 <= _ref5 ? i < _ref5 : i > _ref5; 0 <= _ref5 ? i++ : i--) {
      i1 = i;
      i2 = (_ref6 = i + 1 < this.m_vertexCount) != null ? _ref6 : i + {
        1: 0
      };
    }
