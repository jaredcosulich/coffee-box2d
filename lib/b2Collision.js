...
b2Collision.FindMaxSeparation = function(edgeIndex, poly1, poly2, conservative) {
  var bestEdge, bestSeparation, count1, dLocal1X, dLocal1Y, dX, dY, dot, edge, i, increment, maxDot, nextEdge, prevEdge, s, sNext, sPrev, _ref, _ref2, _ref3, _ref4;
  ...
  prevEdge = (_ref = edge - 1 >= 0) != null ? _ref : edge - {
    1: count1 - 1
  };
  ...
  nextEdge = (_ref2 = edge + 1 < count1) != null ? _ref2 : edge + {
    1: 0
  };
  ...
  while (true) {
    if (increment === -1) {
      edge = (_ref3 = bestEdge - 1 >= 0) != null ? _ref3 : bestEdge - {
        1: count1 - 1
      };
    } else {
      edge = (_ref4 = bestEdge + 1 < count1) != null ? _ref4 : bestEdge + {
        1: 0
      };
    }
    s = b2Collision.EdgeSeparation(poly1, edge, poly2);
